...
def lambda_handler(event, context):
    ...
    # Loop through all of our instances with a tag named "BackupWeekly"
	...
	imagecount = 0
        ...
        for image in images:
            ...
            if image.name.startswith('Lambda -Weekly ' + [result['Value'] for result in instance['Tags'] if result['Key'] == 'Name'][0]):
