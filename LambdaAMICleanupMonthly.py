...
#specify the region in which EC2 Instances located and to cleanup AMI's. Ex: Mumbai region (us-east-2)
...
def lambda_handler(event, context):
    ...
    # Loop through all of our instances with a tag named "BackupMonthly"
	...
	imagecount = 0
        ...
        for image in images:
            ...
            if image.name.startswith('Lambda -Monthly ' + [result['Value'] for result in instance['Tags'] if result['Key'] == 'Name'][0]):
